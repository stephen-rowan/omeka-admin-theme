...
<?php if ($total_results): ?>
    ...
    <form action="<?php echo html_escape(url('items/batch-edit')); ?>" method="post" accept-charset="utf-8">
        ...
        <tbody>
			...
			<?php echo link_to_item(metadata('item', array('Leeds-GATE element set', 'GATE Title'))); ?>
                    ...
                    <div class="details">
                        <?php echo snippet_by_word_count(strip_formatting(metadata('item', array('Leeds-GATE element set', 'GATE Description'))), 40); ?>
